...
- (id)initWithPositionAttribute:(SRAttribute *)positionAttribute colorAttribute:(SRAttribute *)colorAttribute textureAttribute:(SRAttribute *)textureAttribute modelMatrix:(SRUniform *)modelMatrix {
    ...
    if (self) {
        ...
        [vertices setVertex:SRVertexMake(SRPointMake( 1, -1, 0), SRColorMake(1, 0, 0, 1), SRTexCoordMake(1, 0)) atIndex:0];
        [vertices setVertex:SRVertexMake(SRPointMake( 1,  1, 0), SRColorMake(0, 1, 0, 1), SRTexCoordMake(1, 1)) atIndex:1];
        [vertices setVertex:SRVertexMake(SRPointMake(-1,  1, 0), SRColorMake(0, 0, 1, 1), SRTexCoordMake(0, 1)) atIndex:2];
        [vertices setVertex:SRVertexMake(SRPointMake(-1, -1, 0), SRColorMake(0, 0, 0, 1), SRTexCoordMake(0, 0)) atIndex:3];
